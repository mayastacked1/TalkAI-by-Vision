...
// Updated API key and pointing the endpoint destination to Cerebras
const CEREBRAS_API_KEY = process.env.GROQ_API_KEY || 'csk-cfnyfhfeved2k4yfnvfxeyfnwr5mpe5xmn2d3yc88ttvnmwp';
...
const server = http.createServer((req, res) => {
  ...
  if (pathname === '/api/chat' && req.method === 'POST') {
    ...
    req.on('end', () => {
      ...
      // If the incoming model is still set to a Groq string, seamlessly map it to Cerebras's Llama 3.3 70B
